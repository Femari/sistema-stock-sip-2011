...
public class ProcesarPedidoCliente {
	...
	public void ComprometerStockPedidoProveedor(Producto producto, PedidoProveedor pedido, int cantidad)
	{
		...
		if(detalle != null)
		{	//TODO: Agregar validaci�n de que todavia tenga stock para comprometer
	 ...
	 * @return Detalle de errores en caso de que hayan surgido o string vac�o si est� todo ok
	 */
